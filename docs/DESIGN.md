...
> Design notes for **logistics-transcript-actions** — a runnable typescript example that A TypeScript example that turns logistics transcript text into a typed delivery action with Infrai.
...
- **Feature code** — the actual task: logistics-transcript-action.
